"""
Python 2 script for displaying data from a particular event in a ROOT file at a specified index
...
def get_args():
    parser = ArgumentParser(description='Display events from a list of input ROOT files')
